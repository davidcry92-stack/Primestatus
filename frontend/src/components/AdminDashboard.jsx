...
const AdminDashboard = ({ adminUser, onLogout }) => {
  ...
  const tabs = [
    ...
    { id: 'cash-pickups', label: 'Cash Pickup Lookup', icon: '💵' },
    { id: 'prepaid-lookup', label: 'Pre-paid Lookup Verification', icon: '💳' },
    { id: 'daily-reports', label: 'Daily Square Reports', icon: '📈' },
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <div className="flex-1 p-6">
          ...
          {activeTab === 'health-aid-mgmt' && (
            <ErrorBoundary>
              <HealthAidManagement />
            </ErrorBoundary>
          )}
          {activeTab === 'strains-mgmt' && (
            <ErrorBoundary>
              <StrainsManagement />
            </ErrorBoundary>
          )}
