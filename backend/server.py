...
from routes import auth, products, daily_deals, wictionary, orders, cart, admin, admin_auth, ratings, payments
...
if cors_origins == ['*']:
    ...
    if app_domain:
        cors_origins.extend([
            ...
            f"https://cannabis-member.preview.emergentagent.com"
        ])
